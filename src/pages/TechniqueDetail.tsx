    ...
    return (
      <Layout>
        <div className="container text-center">
          ...
          <Link to="/techniques" className="text-primary hover:underline">← Back to Attack Techniques</Link>
        </div>
      </Layout>
    );
  }
    ...
    <Layout>
      ...
      <div className="container max-w-4xl">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          <Link to="/techniques" className="hover:text-foreground transition-colors">Attack Techniques</Link>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="rounded-lg border border-border/50 bg-card p-4">
            <p className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Attack Chains</p>
        ...
        {/* Used in Attack Chains */}
        {usedInPaths.length > 0 && (
          <div className="border-t border-border pt-6 mb-8">
            <h2 className="flex items-center gap-2 font-display text-lg font-semibold mb-4">
              <Crosshair className="h-4 w-4 text-destructive" /> Used in Attack Chains
            </h2>
            <div className="space-y-3">
              {usedInPaths.map((ap) => (
                <Link
