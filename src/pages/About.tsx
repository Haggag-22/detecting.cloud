      ...
      <div className="container py-12 max-w-2xl">
        ...
        <div className="space-y-4 text-muted-foreground leading-relaxed">
          ...
          <ol className="space-y-2 ml-4 list-decimal">
            ...
            <li><strong>Add your rule</strong> to <code className="bg-muted px-1.5 py-0.5 rounded text-sm">src/data/communityRules.ts</code> (community rules only — core rules live under <code className="bg-muted px-1.5 py-0.5 rounded text-sm">rules/&lt;provider&gt;/&lt;rule-slug&gt;/</code>)</li>
